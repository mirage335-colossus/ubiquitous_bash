...
_t 'Similar for &#39;ghci&#39; Haskell interpreter desired (to install with &#39;_setupUbiquitous&#39; to either &#39;.ghci&#39; or a hook there to include another file in &#39;.ubcorerc&#39;).'




_heading2 '+) Environment variables - scriptAbsoluteFolder .'
_t 'Haskell programs will need &#39;scriptAbsoluteFolder&#39; or similar to include Haskell files in adjacent directories, even from the &#39;ghci&#39; interpreter.'
...
_t 'Must not fail due to misquoting of spaces or other possible characters in filenames.'
...
_t 'System.Directory.getCurrentDirectory
...
_t 'if [[ -e /etc/issue ]] && cat /etc/issue | grep &#39;Debian&#39; > /dev/null 2>&1
then
...
_heading1 'Reference'
_t 'https://downloads.haskell.org/~ghc/7.4.1/docs/html/users_guide/loading-source-files.html
	&#39;Prelude> :cd dir&#39;
