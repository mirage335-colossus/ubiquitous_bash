...
export ub_setScriptChecksum_contents='1127643624'
...
if use_colorama:
    ...
    class ubPythonPS1(object):
        ...
        def __str__(self):
            ...
            if self.line == 1:
                prompt = (
                    f"{blue}|{red}#{red}:{yellow}{user}{green}@{green}{hostname}{blue})-{cloud_net_name}({magenta}{bg_white}Python-{py_version}{reset}{blue}){cyan}|\n"
                    #f"{blue}|{white}[{cwd}]\n"
                    f"{white}{cwd}\n"
